void main()
{
  Idol blackPink = const Idol( 
    ...
    ['지수', '제니', '리사', '로제'],    // 그리고 const 생성자에는 const 선언할수 있는 변수만 (빌드 타임값을 알수 있는) 넣을수 있음 
...
// 인스턴스 값이 같더라도 두개의 인스턴스는 다름  => 메모리 주소가 다르기 때문
// 하지만 const 키워드를 이용한 인스턴스는 다름  
...
// const가 없다면 값이 모두 값더라도 다른 인스턴스로 취급함 
  ...
  print("----------------"); 
  print(blackPink == blackPink2);         // 값이 같다고 나옴 
